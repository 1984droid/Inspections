...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-b6g^b*+e5ft%06$qusimx-6b4r=%1c+9j4(o!owyjgz$)waf04')
...
# Set USE_SQLITE=True in .env to use SQLite instead of PostgreSQL (for testing)
...
# Company/facility configuration
COMPANY_NAME = os.getenv('COMPANY_NAME', 'Inspection Company')
